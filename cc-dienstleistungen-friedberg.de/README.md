...
- **Kontakt-E-Mail**: `info@cc-dienstleistungen-friedberg.de` (echtes IONOS-Postfach) auf Formular-Hinweis, Footer, Topbar, Impressum, Datenschutzerklärung, JSON-LD. Zwischenzeitlich stand hier `serkan@gmail.info`, das war aber ein Tippfehler (die Domain `gmail.info` existiert nicht, keine Mail wäre zustellbar gewesen) und wurde korrigiert.
